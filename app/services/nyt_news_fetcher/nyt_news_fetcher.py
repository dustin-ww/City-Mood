...
NYT_FEEDS = [
    {
        ...
        "redis_processed": "rss:nyt:europe:processed_ids",
    ...
    },
    {
        ...
        "redis_processed": "rss:nyt:world:processed_ids",
...
class RssFetcher(BaseFetcher):
    ...
    def analyze_sentiment(self, text: str) -> dict | None:
        ...
        return {
            "label": label.value,      # POSITIVE / NEGATIVE / NEUTRAL
    ...
    def build_rss_event(self, entry: dict, section: str) -> dict:
        ...
        return {
            ...
            # Headline sentiment from flair NLP
    ...
    def process_single_feed(self, feed_cfg: dict):
        ...
        try:
            ...
            for entry in feed.entries:
                ...
                if is_duplicate(feed_cfg["redis_processed"], entry_id):
                    logger.info(f"Skipping duplicate NYT {feed_cfg['name']} entry: {entry.get('title')}")
                    continue
